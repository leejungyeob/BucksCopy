...
| server paper runner 변경 | Python runner syntax check, 15m public candle fetch, file-based status/log persistence, duplicate paper evaluation guard, no private Bitget/order path |
